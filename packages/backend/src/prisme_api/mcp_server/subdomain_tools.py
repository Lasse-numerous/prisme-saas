...
def register_subdomain_tools(mcp: FastMCP) -> None:
    ...
    async def subdomain_create(
        ...
        port: int | None = 80,  # Target port for routing (default: 80)
        released_at: str | None = None,  # When the subdomain was released
        cooldown_until: str | None = None,  # Cooldown period end (30 days after release)
    ) -> dict[str, Any]:
        ...
        Args:
            ...
            port: Target port for routing (default: 80) (optional)
            released_at: When the subdomain was released (optional)
            cooldown_until: Cooldown period end (30 days after release) (optional)
        Returns:
    ...
    async def subdomain_update(
        ...
        dns_record_id: str | None = None,  # Hetzner DNS record ID
        port: int | None = None,  # Target port for routing (default: 80)
        released_at: str | None = None,  # When the subdomain was released
        cooldown_until: str | None = None,  # Cooldown period end (30 days after release)
    ) -> dict[str, Any] | None:
