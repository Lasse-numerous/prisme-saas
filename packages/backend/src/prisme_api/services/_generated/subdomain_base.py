"""Base service for Subdomain.

⚠️ AUTO-GENERATED BY PRISM - DO NOT EDIT
Extend this class in services/subdomain.py to add custom logic.
"""
...
class SubdomainServiceBase(ServiceBase[Subdomain, SubdomainCreate, SubdomainUpdate]):
    """Generated base service for Subdomain.
    ...
    async def list(
        ...
        *,
        skip: int = 0,
        limit: int = 100,
        filters: SubdomainFilter | None = None,
        sort_by: str | None = None,
        sort_order: str = "asc",
        include_deleted: bool = False,
        load_relationships: list[str] | None = None,
    ) -> Sequence[Subdomain]:
        """List Subdomain records with filtering and sorting.
