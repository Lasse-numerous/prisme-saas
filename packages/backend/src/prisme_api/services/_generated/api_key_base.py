"""Base service for APIKey.

⚠️ AUTO-GENERATED BY PRISM - DO NOT EDIT
Extend this class in services/api_key.py to add custom logic.
"""
...
class APIKeyServiceBase(ServiceBase[APIKey, APIKeyCreate, APIKeyUpdate]):
    """Generated base service for APIKey.
    ...
    async def list(
        ...
        *,
        skip: int = 0,
        limit: int = 100,
        filters: APIKeyFilter | None = None,
        sort_by: str | None = None,
        sort_order: str = "asc",
        include_deleted: bool = False,
        load_relationships: list[str] | None = None,
    ) -> Sequence[APIKey]:
        """List APIKey records with filtering and sorting.
