...
Self-issued JWT session validation for the custom auth UX.
"""
...
SESSION_TOKEN_EXPIRY = timedelta(days=7)
...
async def get_current_user(
    ...
    """Get current authenticated user from self-issued JWT session.
