...
import { useUserList, useUserMutations } from '../../hooks/useUser';
...
export default function UsersListPage(): JSX.Element {
  ...
  const { data, loading, error, totalCount, hasNextPage, hasPreviousPage, refetch } = useUserList({
    page,
    pageSize: 20,
  });
  const { remove, loading: mutating } = useUserMutations();
