...
import { useAPIKey, useAPIKeyList, useAPIKeyMutations } from '../../hooks/useAPIKey';
...
describe('useAPIKey', () => {
  ...
  it('returns loading state initially when id is provided', () => {
    const { result } = renderHook(() => useAPIKey(1), { wrapper: Wrapper });
  ...
  it('handles null id', () => {
    const { result } = renderHook(() => useAPIKey(null), { wrapper: Wrapper });
...
describe('useAPIKeyList', () => {
  ...
  it('returns initial state', () => {
    const { result } = renderHook(() => useAPIKeyList(), { wrapper: Wrapper });
  ...
  it('accepts pagination options', () => {
    const { result } = renderHook(
      () => useAPIKeyList({ page: 2, pageSize: 10 }),
      { wrapper: Wrapper }
    );
...
describe('useAPIKeyMutations', () => {
  ...
  it('provides create function', () => {
    const { result } = renderHook(() => useAPIKeyMutations(), { wrapper: Wrapper });
